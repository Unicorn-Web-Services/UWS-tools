...
class GenericDockerManager:
    def __init__(self, base_port=8000, container_name="fastapi-app", image_name="fastapi-app", 
                 repo_url="https://github.com/Unicorn-Web-Services/UWS-tools", project_dir="/Buckets", app_module="buckets:app"):
    ...
    def run_container(self):
        ...
        try:
            ...
            cmd = [
                ...
                "-v", f"{self.project_dir}/uploads:/app/uploads",
                "-v", f"{self.project_dir}/data:/app/data",
